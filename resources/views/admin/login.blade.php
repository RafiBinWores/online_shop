...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | Adminto - Online Shop Admin Dashboard</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="text-center">
                        ...
                        <p class="text-muted mt-2 mb-4"><span class="text-danger">Online Shop</span> Admin Dashboard</p>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <p> <a href="pages-recoverpw.html" class="text-primary ms-1"><i
